...
You'll notice that "llm-to-matrix" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "llm-to-matrix" and its variances with your own
project's name.
...
```
llm-to-matrix other-config.yaml
```
