...
The majority of the code is kept inside of the `llm-to-matrix` folder, which
...
To run the bot, the `llm-to-matrix` script in the root of the codebase is
